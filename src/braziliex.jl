_braziliexauth = Dict("key"=>"empty","secret"=>"empty")

function braziliexsetauth(key::String,secret::String)
	global _braziliexauth = Dict("key"=>key,"secret"=>secret)
end
...
module Braziliex
	...
	publicurl = "https://braziliex.com/api/v1/public/"
	 ...
	 braziliexapisecret = "empty"
	 Braziliexapikey = "empty"
	...
	function privaterequest(command::String;secret::String=Main._braziliexauth["secret"], key::String=Main._braziliexauth["key"])		
		...
		if (secret == "empty")
			...
			print_with_color(:blue,"           You can do it by using braziliexsetauth(key::String,secret::String).\n")
			print_with_color(:red,"========================================================================\n")		
			return void
		else
